...
//  StrikeZone
//
//  Created by Patrick Landin on 1/27/15.
...
class OptionsTableViewController: UITableViewController {
  ...
  override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
    if segue.identifier == "SHOW_MAP" {
      let strikeZoneViewController = segue.destinationViewController as StrikeZoneViewController
      let selectedIndexPath = self.tableView.indexPathForSelectedRow()
      strikeZoneViewController.selectedPitcher = self.selectedPitcher
    }
